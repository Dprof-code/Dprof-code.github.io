      ...
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="space-y-6 md:space-y-8 text-white z-10 order-2 lg:order-1">
            ...
            >
              <span className="text-secondary font-medium sm:text-lg md:text-xl tracking-wider">
                Hi, I&apos;m Abraham
              </span>
              <p className="text-3xl sm:text-4xl md:text-6xl font-bold mt-2 leading-tight">
                I build websites, e-commerce sites, web apps.
              </p>
            </motion.div>
                ...
                >
                  <div className="relative z-10 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl p-2 w-full">
                    <img
                      ...
                      className="rounded-xl shadow-2xl transform hover:scale-105 transition-transform duration-300 w-full object-cover"
                      loading="lazy"
                    />
