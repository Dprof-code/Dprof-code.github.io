  ...
  return (
    <section id="portfolio" className="py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        {error && !loading && (
          <div className="flex justify-center items-center py-12">
            <div className="text-red-400 text-lg">Failed to load projects. Please try again later.</div>
          </div>
        )}
        ...
        {!loading && !error && projects.length === 0 && (
          <div className="flex justify-center items-center py-12">
            <div className="text-gray-400 text-lg">No projects available at the moment.</div>
          </div>
        )}
      </div>
    </section>
